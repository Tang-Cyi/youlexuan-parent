...
<head>
	...
	<script>
		/*把itemList id price title spec  构造集合对象 */
		var skuList=[
			<#list itemList as item>
			{
				'id':${item.id?c},
				'price':${item.price?c},
				'title':"${item.title!''}",/*定义默认值 这里是字符串，需要手动加双引号 '' */
				'spec':${item.spec!''}
			}, /*这里记得加逗号*/
			</#list>
		]
							...
							<#list specificationList as specification>
								<dl>
									...
									<#list specification.attributeValue as item>
										<dd><a class="{{isSelect('${specification.attributeName}','${item}')?'selected':''}} "
											   ng-click="selectSpecification('${specification.attributeName}','${item}')" href="javascript:;">
						...
						<div class="summary-wrap">
							<div class="fl title">
								<div class="control-group">
									<div class="controls">
										<input autocomplete="off"  value="{{num}}" type="text" value="1" minnum="1" class="itxt" />
