...
public class SellerServiceImpl implements SellerService {
    ...
    @Override
    public int updatePassword(String selerId, String oldPassword, String newPassword) {
        TbSeller seller = findOne(selerId);
        if (oldPassword == null || !oldPassword.equals(seller.getPassword()))  return 0;
