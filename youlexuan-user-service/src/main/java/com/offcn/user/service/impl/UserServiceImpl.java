...
import com.offcn.util.SendSmsUtils;
...
public class UserServiceImpl implements UserService {
	...
	public boolean checkSmsCode(String phone, String code) {
		String smsCode = redisTemplate.boundHashOps("smscode").get(phone)+"";
		if ((smsCode.length()==0)||(!smsCode.equals(code))) return false;
		return true;
	}
	...
	public void createSmsCode(String phone) {
		...
		SendSmsUtils.sendSmsCode(phone,code);
